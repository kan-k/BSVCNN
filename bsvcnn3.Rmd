...
Load 
```{r}
p.in.sgd <- as.data.frame(t(read_feather('/well/nichols/users/qcv214/bnn2/res3/pile/sim_ju3_nnvwb4_inpred__jobid_2.feather')))
p.out.sgd <- as.data.frame(t(read_feather('/well/nichols/users/qcv214/bnn2/res3/pile/sim_ju3_nnvwb4_outpred__jobid_2.feather')))
