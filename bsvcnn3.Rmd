...
epoch <- 20
#Get the best performance
w.1e10 <- as.matrix(read_feather(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/nn_adam2_theta_",0.1,".feather")))
...
epoch <- 20
#Get the best performance
w.1e10 <- as.matrix(read_feather(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/nn_adamW2_theta_",0.3,".feather")))
plot(density(w.1e10[4,]))
# lines(density(w.1e10[2,]))
# lines(density(w.1e10[3,]))
for(i in 1:12){
