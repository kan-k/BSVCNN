...
write.csv(rbind(out.hs,out.nm,out.mfvb),paste0("/well/nichols/users/qcv214/bnn2/pile/whole_brain",poly_degree,a_concentration,b_smoothness,"_",JobId,".csv"), row.names = FALSE)
