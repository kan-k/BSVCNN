...
dat_allmat<- scale(dat_allmat)[1:dim(dat_allmat)[1],]
...
write.csv(rbind(out.hs,out.nm,out.mfvb),paste0("/well/nichols/users/qcv214/bnn2/pile/bsvcnn14feb_gs_sc_",JobId,".csv"), row.names = FALSE)
