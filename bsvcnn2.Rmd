...
pca_lm.pred <- as.matrix(read.csv(paste0("/well/nichols/users/qcv214/bnn2/pile/pca_lm_pred_usc90_",4,".csv")))
#in-sample
plot(pca_lm.pred[1,],pca_lm.pred[3,], xlab = "True age", ylab = "predictions", main = "in-sample" )
abline(lm(pca_lm.pred[3,] ~ pca_lm.pred[1,]),col="blue")
abline(a=0,b=1,lwd=2,col="red")
...
pca_lm.pred <- as.matrix(read.csv(paste0("/well/nichols/users/qcv214/bnn2/pile/pca_lm_pred_usc50_",4,".csv")))
#in-sample
plot(pca_lm.pred[1,],pca_lm.pred[3,], xlab = "True age", ylab = "predictions", main = "in-sample" )
abline(lm(pca_lm.pred[3,] ~ pca_lm.pred[1,]),col="blue")
abline(a=0,b=1,lwd=2,col="red")
...
pca_lm.pred <- as.matrix(read.csv(paste0("/well/nichols/users/qcv214/bnn2/pile/pca_lm_pred_usc25_",4,".csv")))
#in-sample
plot(pca_lm.pred[1,],pca_lm.pred[3,], xlab = "True age", ylab = "predictions", main = "in-sample" )
abline(lm(pca_lm.pred[3,] ~ pca_lm.pred[1,]),col="blue")
abline(a=0,b=1,lwd=2,col="red")
