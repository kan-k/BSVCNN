...
for(e in 1:epoch){
  ...
  if(e %in% c(25,50,80)){
    ...
    write_feather(as.data.frame(salient.mat),paste0('/well/nichols/users/qcv214/bnn2/res3/pile/re_oct7_stgp2_saliencymatrix_seed_',JobId,"_epoch_",e))
  }
}
