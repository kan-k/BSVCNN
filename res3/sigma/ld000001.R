...
theta.matrix <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/re_sep7_nnig4_theta_',"_jobid_",12,'.feather')))
...
bias<- as.vector(unlist(read.csv( '/well/nichols/users/qcv214/bnn2/res3/pile/re_sep7_nnig4_bias__jobid_12.csv')))

#Load latest variance
prior.var <- tail(as.vector(unlist(read.csv(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/re_sep7_nnig4_invgam_',"_jobid_",12,".csv")))),n.mask)
