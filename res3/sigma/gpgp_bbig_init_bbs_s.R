...
filename <- "apr26_gpgp_init_ext_bbs_s" 
init.num <- 10
...
alpha.init <-  read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr26_gpnngpgp_beta5_init_s_minalpha__jobid_",init.num,".csv"))$x #shape
beta.init <-  read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr26_gpnngpgp_beta5_init_s_minbeta__jobid_",init.num,".csv"))$x #scale
...
#Define init var
prior.var <-  read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr26_gpnngpgp_beta5_init_s_minpriorvar__jobid_",init.num,".csv"))$x#Mean of IG

#Fix prior var to be 0.1
# prior.var <- 1.5
y.sigma <- read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr26_gpnngpgp_beta5_init_s_minsigma__jobid_",init.num,".csv"))$x
y.sigma.vec <- y.sigma
...
theta.matrix <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/re_apr26_gpnngpgp_beta5_init_s_mintheta__jobid_',init.num,'.feather')))
# weights <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/re_apr26_gpnngpgp_beta5_init_s_minweights__jobid_',init.num,'.feather')))

#Initialising bias (to 0)
bias <- read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr26_gpnngpgp_beta5_init_s_minbias__jobid_",init.num,".csv"))$x
