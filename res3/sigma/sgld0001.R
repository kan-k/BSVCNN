...
# prior.var <- 1.5
y.sigma <- tail(as.vector(unlist(read.csv( '/well/nichols/users/qcv214/bnn2/res3/pile/re_oct6_stgpols_sigma__jobid_1.csv'))),1)
y.sigma.vec <- y.sigma
...
theta.matrix <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/re_oct6_stgpols_theta_',"_jobid_",1,'.feather')))
...
bias<- as.vector(unlist(read.csv( '/well/nichols/users/qcv214/bnn2/res3/pile/re_oct6_stgpols_bias__jobid_1.csv')))
