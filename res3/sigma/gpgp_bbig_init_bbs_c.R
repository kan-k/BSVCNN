...
filename <- "apr24_gpnngpgp_bbig_init_ext_bbs_c" 
init.num <- 7
...
alpha.init <-  read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnngpgp_bb_ig_beta5_init_c_minalpha__jobid_",init.num,".csv"))$x #shape
beta.init <-  read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnngpgp_bb_ig_beta5_init_c_minbeta__jobid_",init.num,".csv"))$x #scale
...
#Define init var
prior.var <-  read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnngpgp_bb_ig_beta5_init_c_minpriorvar__jobid_",init.num,".csv"))$x#Mean of IG

#Fix prior var to be 0.1
# prior.var <- 1.5
y.sigma <- read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnngpgp_bb_ig_beta5_init_c_minsigma__jobid_",init.num,".csv"))$x
y.sigma.vec <- y.sigma
...
theta.matrix <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnngpgp_bb_ig_beta5_init_c_mintheta__jobid_',init.num,'.feather')))
# weights <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnngpgp_bb_ig_beta5_init_c_minweights__jobid_',init.num,'.feather')))

#Initialising bias (to 0)
bias <- read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnngpgp_bb_ig_beta5_init_c_minbias__jobid_",init.num,".csv"))$x
