...
filename <- "apr24_gpnnols_bbig_init_ext_bbs_c" #Was feb27
init.num <- 2
...
alpha.init <-  read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnnols_bb_ig_beta5_init_com_minalpha__jobid_",init.num,".csv"))$x #shape
beta.init <-  read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnnols_bb_ig_beta5_init_com_minbeta__jobid_",init.num,".csv"))$x #scale
...
#Define init var
prior.var <-  read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnnols_bb_ig_beta5_init_com_minpriorvar__jobid_",init.num,".csv"))$x#Mean of IG

#Fix prior var to be 0.1
# prior.var <- 1.5
y.sigma <- read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnnols_bb_ig_beta5_init_com_minsigma__jobid_",init.num,".csv"))$x
y.sigma.vec <- y.sigma
...
theta.matrix <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnnols_bb_ig_beta5_init_com_mintheta__jobid_',init.num,'.feather')))
# weights <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnnols_bb_ig_beta5_init_com_minweights__jobid_',init.num,'.feather')))

#Initialising bias (to 0)
bias <- read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/re_apr24_gpnnols_bb_ig_beta5_init_com_minbias__jobid_",init.num,".csv"))$x
time.train <-  Sys.time()
