...
prior.var.vec <- c(0.01,0.1)
prior.var.mat <- expand.grid(2:11,prior.var.vec)
...
theta.matrix <- matrix(rnorm(n.mask*n.expan,0,sqrt(prior_var)),nrow=n.mask, ncol= n.expan) #Initialise with Norm(0,0.9)
...
write.csv(rbind(loss.train,loss.val),paste0("/well/nichols/users/qcv214/bnn2/res3/pile/nnb5_loss_",learning_rate,"_seed_",seed,"_jobid_",JobId,".csv"), row.names = FALSE)
write_feather(as.data.frame(weights),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/nnb5_weights_',learning_rate,"_seed_",seed,"_jobid_",JobId,'.feather'))
write_feather(as.data.frame(theta.matrix),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/nnb5_theta_',learning_rate,"_seed_",seed,"_jobid_",JobId,'.feather'))
write.csv(bias,paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/nnb5_bias_',learning_rate,"_seed_",seed,"_jobid_",JobId,".csv"), row.names = FALSE)
