...
# }
source("/well/nichols/users/qcv214/bnn2/res3/region_gp_create.R")
...
write.csv(rbind(loss.train,loss.val),paste0("/well/nichols/users/qcv214/bnn2/res3/pile/nn_reg1_loss_",learning_rate,"_jobid_",JobId,".csv"), row.names = FALSE)
write_feather(as.data.frame(weights),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/nn_reg1_weights_',learning_rate,"_jobid_",JobId,'.feather'))
write_feather(as.data.frame(theta.matrix),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/nn_reg1_theta_',learning_rate,"_jobid_",JobId,'.feather'))
write.csv(bias,paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/nn_reg1_bias_',learning_rate,"_jobid_",JobId,".csv"), row.names = FALSE)
