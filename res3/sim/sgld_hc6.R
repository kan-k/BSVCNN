...
write.csv(rbind(loss.train,loss.val),paste0("/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_loss_","_jobid_",JobId,".csv"), row.names = FALSE)
write_feather(as.data.frame(weights),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_weights_',"_jobid_",JobId,'.feather'))
write_feather(as.data.frame(theta.matrix),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_theta_',"_jobid_",JobId,'.feather'))
write.csv(bias,paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_bias_',"_jobid_",JobId,".csv"), row.names = FALSE)
write_feather(as.data.frame(rbind(pred.train.ind,pred.train.val)),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_inpred_',"_jobid_",JobId,'.feather'))
write_feather(as.data.frame(rbind(pred.test.ind,pred.test.val)),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_outpred_',"_jobid_",JobId,'.feather'))

#inv gamme param
write.csv(conj.alpha,paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_alpha_',"_jobid_",JobId,".csv"), row.names = FALSE)
write.csv(conj.beta,paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_beta_',"_jobid_",JobId,".csv"), row.names = FALSE)
write.csv(conj.invgamma,paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_invgam_',"_jobid_",JobId,".csv"), row.names = FALSE)
write.csv(conj.cv,paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_j22_nnvwbsgldhc_Cv_',"_jobid_",JobId,".csv"), row.names = FALSE)