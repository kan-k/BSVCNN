...
write.csv(out.hs,paste0("/well/nichols/users/qcv214/bnn2/res3/pile/sim_wb_",poly_degree,a_concentration,b_smoothness,"_",JobId,".csv"), row.names = FALSE)
write.csv(c(hs_pred_SOI),paste0("/well/nichols/users/qcv214/bnn2/res3/pile/sim_wb_outpred_noscale_",JobId,".csv"), row.names = FALSE)
write.csv(c(hs_in.pred_SOI),paste0("/well/nichols/users/qcv214/bnn2/res3/pile/sim_wb_inpred_noscale_",JobId,".csv"), row.names = FALSE)
####Result to use
write.csv(rbind(c(ind.to.use$train),c(ind.to.use$test)),paste0("/well/nichols/users/qcv214/bnn2/res3/pile/sim_wb_index_",JobId,".csv"), row.names = FALSE)
write_feather(as.data.frame(c(hs_fit_SOI$post_mean$betacoef[1],beta_fit$HS)),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_wb_coef_',JobId,'.feather'))