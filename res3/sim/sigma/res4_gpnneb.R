...
# write.csv(c(prior.var.mat[JobId,2]),paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_',filename,'_privar_',"_jobid_",JobId,".csv"), row.names = FALSE)
