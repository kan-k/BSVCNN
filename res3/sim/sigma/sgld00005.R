...
# prior.var <- 1.5
y.sigma <- tail(c(as.matrix(read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/pile/sim_sep7_nnvwb4_sigma__jobid_11.csv")))),1)
y.sigma.vec <- y.sigma
...
theta.matrix <- as.matrix(read_feather(paste0( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_sep7_nnvwb4_theta_',"_jobid_",11,'.feather')))
...
bias<- as.vector(unlist(read.csv( '/well/nichols/users/qcv214/bnn2/res3/pile/sim_sep7_nnvwb4_bias__jobid_11.csv')))
