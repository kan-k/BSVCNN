...
write.csv(rbind(loss.train,loss.val),paste0("/well/nichols/users/qcv214/bnn2/res3/pile/nn_loss_",JobId,".csv"), row.names = FALSE)
write_feather(as.data.frame(weights), '/well/nichols/users/qcv214/bnn2/res3/pile/nn_weights_',JobId,'.feather')
