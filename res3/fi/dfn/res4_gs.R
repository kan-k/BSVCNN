...
dat_allmat <- as.matrix(fast_read_imgs_mask(list_of_all_images,'/well/nichols/users/qcv214/bnn2/res3/res4mask'))
#load age
#data
#Age
...
for(k in mask.reg.part[[JobId]]){
  ...
  write.csv(opt.pos,paste0("/well/nichols/users/qcv214/bnn2/res3/fi/pile/dfn_res4_gs19oct_ROI_",k,".csv"), row.names = FALSE)
}