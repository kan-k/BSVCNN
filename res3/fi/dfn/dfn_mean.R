...
# temp.img[temp.img>0] <- dat_colmeans  #threshold of 0.5
dat_colsd <- apply(res3.dat, 2, sd)
temp.img[temp.img>0] <- dat_colsd

temp.img@datatype = 16
temp.img@bitpix = 32
writeNIfTI(temp.img,'/well/nichols/users/qcv214/bnn2/res3/fi/dfn/sd_res3mask_nowm')
...
# res3.mask <-oro.nifti::readNIfTI('/well/nichols/users/qcv214/bnn2/res3/fi/dfn/mean_res3mask.nii.gz')
