...
coord.centroid <- as.matrix(read.csv(paste0("/well/nichols/users/qcv214/bnn2/res3/coord_centroids.csv")))[-c(2,3,8,9),]
...
# write_feather(as.data.frame(bases.nb),paste0("/well/nichols/users/qcv214/bnn2/res3/roi/partial_gp_centroids_fixed_",poly_degree,a_concentration,b_smoothness,".feather"))
