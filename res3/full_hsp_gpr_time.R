...
write.csv(time.taken, "/well/nichols/users/qcv214/bnn2/res3/pile/full_hsp_time.csv")
...
print(Sys.time())
cat("Training complete in: ", time.taken)
write.csv(time.taken, "/well/nichols/users/qcv214/bnn2/res3/pile/full_gpr_time.csv")
