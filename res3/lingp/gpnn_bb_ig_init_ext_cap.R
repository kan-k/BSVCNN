...
filename <- "feb10_gpnn_bb_ig_init_ext_cap"
...
for(e in 1:epoch){
  ...
  for(b in 1:num.batch){
    ...
    if(it.num < epoch*num.batch){
      ...
      print(paste0('dim weights: ',dim(weights)))
      print(paste0('summary weights: ',summary(c(weights))))
      print(paste0('bias: ',bias))
      print(paste0('prior.var: ',prior.var))
    }
