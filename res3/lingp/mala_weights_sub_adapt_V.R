...
filename <- "mar29_mala_weights_sub_adapt25_V"
init.num <- 2
...
for (i in 1:num_iterations) {
  ...
  print(paste0("Iteration: ",i," out of ",num_iterations,", training loss: ",mse(hs_in.pred_SOI,age),", Change lr: ",prop.change.step.size,"%", ", iteration: ",Sys.time() -time.epoch))
