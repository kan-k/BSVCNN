...
```{r}
mape <- function(true_vec, obs_vec){
  return(mean(abs(true_vec-obs_vec)*100/true_vec))
}
```
...
plot(x= runs,y=res.mat[,1],col='red',lwd=2, type = 'l',main = "Mean Abs % Error", ylab="MAPE", xlab="runs",ylim=c(-800,140))
