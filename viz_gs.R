...
writeNIfTI(gp.mask.hs,paste0('/well/nichols/users/qcv214/bnn2/viz/gs_gp_hs'))
writeNIfTI(gp.mask.nm,paste0('/well/nichols/users/qcv214/bnn2/viz/gs_gp_nm'))
