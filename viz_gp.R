...
writeNIfTI(gp.mask.hs,paste0('/well/nichols/users/qcv214/bnn2/viz/def_gp_hs'))
writeNIfTI(gp.mask.nm,paste0('/well/nichols/users/qcv214/bnn2/viz/def_gp_nm'))
# writeNIfTI(gp.mask.hs,paste0('/well/nichols/users/qcv214/bnn2/viz/scatter_gp_hs'))
# writeNIfTI(gp.mask.nm,paste0('/well/nichols/users/qcv214/bnn2/viz/scatter_gp_nm'))
